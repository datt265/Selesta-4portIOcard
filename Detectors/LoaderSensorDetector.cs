...
namespace Detectors
{
    public class LoaderSensorDetector : LoaderDetector
    {
        ...
        public LoaderSensorDetector(HIDIODevice ioCard) : base(ioCard)
        {
        ...
        void _ioCard_OnReceiveData(object sender, InputChangedEventArgs args)
        {
            ...
            {
                _loaderPresent = args.devicest.input_0 ? LoaderPresenceEnum.LoaderNotEmpty : LoaderPresenceEnum.LoaderEmpty;
            }
